...
export default class Utils {
    ...
    fuzzification(data){
        ...
        let centrado = this.memeberships.triangle(distancia, -20, 0, 60);
        let cercaA = this.memeberships.trapezoid(distancia, 10, 60, 100, 180);
        let normalA = this.memeberships.trapezoid(distancia, 100, 130, 210, 240);
